...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/foridream/v2ray1/master/V2Ray_ws-tls_bash/install.sh" && chmod +x install.sh && bash install.sh
```
